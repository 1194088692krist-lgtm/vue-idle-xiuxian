      ...
      <div class="card-body">
        ...
        <div class="crystal-exchange">
          <div class="exchange-info">
            ...
            <span class="rate">1000 灵石 = 1 幻灵结晶</span>
          </div>
          <div class="exchange-actions">
            <button class="btn btn-info" :disabled="playerStore.spiritStones < 10000" @click="exchangeCrystals(10)">兑换10</button>
            <button class="btn btn-info" :disabled="playerStore.spiritStones < 50000" @click="exchangeCrystals(50)">兑换50</button>
            <button class="btn btn-info" :disabled="playerStore.spiritStones < 100000" @click="exchangeCrystals(100)">兑换100</button>
            <button class="btn btn-info" :disabled="playerStore.spiritStones < 1000000" @click="exchangeCrystals(1000)">兑换1000</button>
          </div>
        </div>
