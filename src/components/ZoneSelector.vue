        ...
        <div class="team-members">
          ...
          >
            <div class="member-avatar">
              <img v-if="getCharacterThumbnail(member)" :src="getCharacterThumbnail(member)" class="member-avatar-img" :alt="member.name" />
              ...
              <div class="sect-members-grid">
                ...
                >
                  <div class="sect-avatar">
                    <img v-if="getCharacterThumbnail(member)" :src="getCharacterThumbnail(member)" class="sect-avatar-img" :alt="member.name" />
                    <span v-else>{{ member.name[0] }}</span>
                  </div>
