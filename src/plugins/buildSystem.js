...
const affixPool = [
  ...
  { id: 'rapid_strike', name: '连击', stat: 'comboRate', valueType: 'percent', baseRange: [0.02, 0.06], tier: 2, slots: ['hands', 'artifact'] },
  { id: 'vampiric', name: '吸血', stat: 'vampireRate', valueType: 'percent', baseRange: [0.02, 0.05], tier: 2, slots: ['wrist', 'ring1', 'artifact'] },
  ...
  { id: 'dodge_resist', name: '命击', stat: 'dodgeResist', valueType: 'percent', baseRange: [0.02, 0.05], tier: 2, slots: ['hands', 'ring1', 'artifact'] },
...
const setBonuses = [
  ...
  },
  {
    ...
    pieces: ['artifact', 'wrist', 'ring1', 'hands'],
    color: '#DC143C',
  ...
  },
  {
    ...
    pieces: ['body', 'ring1', 'ring2', 'artifact'],
    color: '#FF69B4',
  ...
  },
  {
    ...
    pieces: ['head', 'body', 'feet', 'artifact'],
    color: '#FFD700',
    bonus2: { stat: 'attack', value: 0.1, valueType: 'percent', label: '2件套：攻击+10%' },
