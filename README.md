...
> **当前版本：2.1.0 · 天道劫起（2026-07-28）** — 一款基于 Vue 3 的放置（idle）修仙游戏：自动/离线修炼、装备 Build、灵宠、挂机探索、抽卡、丹药、战斗与灵石阁补缺枢纽一应俱全。

[![version](https://img.shields.io/badge/version-2.1.0%20·%20天道劫起-blue.svg)](./package.json)
