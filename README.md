...
- **人物形态 BOSS 系统（2.2.0）**：八大秘境按图与难度分配星级，挂机结束随机刷新人物形态 BOSS（比普通 BOSS 难 50%，出现概率 60%~80%），击败必掉角色「内丹碎片」并有概率掉专属挑战券，50 个角色全覆盖。
- **专属装备系统（2.2.0）**：八卦炉「专属锻打」消耗 1 件神品装备 + 100 个角色内丹碎片，为角色打造 6 部位专属神品装备，对应角色穿戴整体数值 ×1.3，强化上限 +15。
- **皮肤商店联动（2.2.0）**：突破 N 级解锁皮肤 N（1~5），皮肤 6/7 在灵石阁随机刷新（100 万灵石/张）；支持按拥有状态过滤、立绘弹窗查看。
...
- **人物形态 BOSS 系统**：八大秘境按图/难度分配星级，挂机结束随机刷新人物 BOSS（难 50%、出现率 60%~80%），必掉角色「内丹碎片」并概率掉专属挑战券（50 角色全覆盖）。
- **专属装备系统**：八卦炉「专属锻打」消耗 1 件神品装备 + 100 个角色内丹碎片，打造 6 部位专属神品装备（对应角色穿戴 ×1.3，强化上限 +15）；八卦炉改为 2×2 田字布局，专属锻打支持神品装备筛选。
- **皮肤商店联动**：突破 N 级解锁皮肤 N（1~5），皮肤 6/7 在灵石阁随机刷新（100 万灵石/张，刷新 10 万/次）；支持按拥有状态过滤、立绘弹窗查看。
